      ...
      <div class="bg-white p-4 rounded-lg border border-slate-200 shadow-xs flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h3 class="text-xs font-extrabold uppercase tracking-wider text-slate-800 flex items-center space-x-1.5">
            ...
            <span>Peso / Coeficiente da Disciplina (Turma {{ turmaSelecionada.ano }} - {{ turmaSelecionada.turma }})</span>
          </h3>
          <p class="text-xs text-slate-500 mt-0.5">
            Ajuste livremente o multiplicador/peso dos bimestres para calcular em tempo real os pontos de contribuição (Nota × Peso / 10) e a Média Ponderada da sua matéria.
          </p>
        </div>

        <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
          <!-- Inputs de Pesos (Coeficientes da Disciplina) -->
          ...
          <div class="text-xs font-bold text-slate-700 bg-slate-100 px-3 py-2 rounded border border-slate-200">
